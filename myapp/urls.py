...
urlpatterns = [
    ...
    # 项目管理系统API
    path('admin/department/list', views.admin.department_list),
    path('admin/department/create', views.admin.create_department),
    path('admin/department/update', views.admin.update_department),
    path('admin/department/delete', views.admin.delete_department),
    
    path('admin/projectType/list', views.admin.project_type_list),
    path('admin/projectType/create', views.admin.create_project_type),
    path('admin/projectType/update', views.admin.update_project_type),
    path('admin/projectType/delete', views.admin.delete_project_type),
    
    path('admin/projectStatus/list', views.admin.project_status_list),
    path('admin/projectStatus/create', views.admin.create_project_status),
    path('admin/projectStatus/update', views.admin.update_project_status),
    path('admin/projectStatus/delete', views.admin.delete_project_status),
    
    path('admin/project/list', views.admin.project_list),
    path('admin/project/create', views.admin.create_project),
    path('admin/project/update', views.admin.update_project),
    path('admin/project/delete', views.admin.delete_project),
    
    path('admin/task/list', views.admin.task_list),
    path('admin/task/create', views.admin.create_task),
    path('admin/task/update', views.admin.update_task),
    path('admin/task/delete', views.admin.delete_task),
    path('admin/task/tasksByProject', views.admin.tasks_by_project),
